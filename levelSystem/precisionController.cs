...
/// <summary>
/// precisionController es una clase utilizada para controlar el texto relacionado con la precisión en la UI de
...
public class precisionController : MonoBehaviour, ISelectHandler
{
    ...
    void Update()
    {
        ...
        if (EventSystem.current.currentSelectedGameObject == gameObject)
        {
            ...
            //Pulsamos el botón asociado a la acción mapeada a aceptar
