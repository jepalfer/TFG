...
public class collisionController : MonoBehaviour
{
    ...
    private bool _isOnOneWay = false;
    ...
    void Update()
    {
        if (!UIController.getIsPaused() && !UIController.getIsInEquipUI() && !UIController.getIsLevelingUp() && !UIController.getIsAdquiringSkills() && !UIController.getIsLevelingUpWeapon())
        {
