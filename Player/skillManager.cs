...
public class skillManager : MonoBehaviour
{
    ...
    public GameObject getSkillToEquip(skillType type, int id)
    {
        GameObject skill;

        if (type == skillType.COMBO)
        {
        ...
        else
        {
            for (int i = 0; i < 3; ++i)
            {
                if (equippedData.getIDs()[i] != -1)
                {
                    ...
                    if (_equippedSkills[i] != null)
                    {
                        if (equippedData.getTypes()[i] == skillType.COMBO)
                        {
                        ...
                        else if (equippedData.getTypes()[i] == skillType.STAT)
                        {
                        ...
                        else if (equippedData.getTypes()[i] == skillType.STATUS)
                        {
